...
Aqua::Render::Render(std::shared_ptr<Shader> shader) {
	shader = shader;
...
void Aqua::Render::DrawSprite(std::shared_ptr<Texture> texture, vec2 pos, vec2 scale, float rotation, vec3 color) {
	this->shader->Use();
